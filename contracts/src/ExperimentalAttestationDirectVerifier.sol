...
contract ExperimentalAttestationDirectVerifier is IDirectVerifier {
    ...
    /// @param proof ABI encoding of `(bytes32 sourceTrustRoot, bytes signature)`.
        ...
        returns (bytes32 sourceTrustRoot)
    {
        ...
        (sourceTrustRoot, signature) = abi.decode(proof, (bytes32, bytes));
        ...
        if (ecrecover(digest, v, r, s) != authorizedSigner) revert InvalidSignature();
    }
}
